...
const prodimg = products.filter(function (img) {
  if (img.photos == "" || img.photos == undefined) {
  } else return img.photos;
});

console.log(prodimg);

const prodsort = products.sort(function (a, b) {
